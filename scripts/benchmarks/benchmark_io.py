...
def write_cv2(): return cv2.imwrite("out_cv2.png", image_np)
def write_imageio(): return imageio.imwrite("out_imageio.png", image_np)
def write_pil(): return Image.fromarray(image_np).save("out_pil.png")
def write_tiff(): return tifffile.imwrite("out_tiff.tif", image_np)
